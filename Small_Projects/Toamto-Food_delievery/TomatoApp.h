...
public:
    ...
    Order* checkoutNow(User* user, const string& orderType) {
        return checkout(user, orderType, new NowOrderFactory());
    }

    Order* checkoutScheduled(User* user, const string& orderType, const string& scheduleTime) {
        return checkout(user, orderType, new ScheduledOrderFactory(scheduleTime));
    }

    Order* checkout(User* user, const string& orderType, OrderFactory* orderFactory) {
