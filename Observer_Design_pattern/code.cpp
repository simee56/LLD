...
// are notified and updated automatically — without the Subject needing to know 
...
int main() {
    ...
    Channel* channel = new Channel("Sim_sim__56");

    Subscriber* subs1 = new Subscriber("Riya", channel);
    Subscriber* subs2 = new Subscriber("Siya", channel);
