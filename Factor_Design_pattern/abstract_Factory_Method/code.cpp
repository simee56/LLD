// A creational pattern where one factory interface declares methods to create several related products,
//  and each concrete factory produces the whole family,
