// A creational pattern where object creation is delegated to subclasses of a creator class,
// instead of one method with an if/switch. Each subclass overrides the factory method to produce 
...
int main() {
    string type;
    cout << "Which type of burger do you want : basic/standard/premimum - ";
    cin >> type;
